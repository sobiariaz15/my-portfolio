...
export default function Home() {
  return (
    <main className = " w-screen h-screen relative" > 
      <div className ='flex item-centre  w-full h-full bg-cover bg-centre ' style= {{backgroundImage:"url(/main-bg.webp)"}}>
      ...
      <  div className="  flex absolute bottom-10 z-[20] right-5 flex-col md:hidden gap-5">
            ...
            <Link href= "/my-projects" className="rounded-[20px] group relative bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px] gap-5">
                My Projects
            </Link>
            <Link href= "/contact-me" className="rounded-[20px] group relative bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px] gap-5">
                Contact me
            </Link>
           </div>
           <div className="absolute bottom-0 right-0 z-[10]">
          <img src="/horse.png" alt="Description of the image"
          height= {300}
          width= {300}
